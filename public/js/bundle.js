...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJvbWlzZW9rZW5uYSIsImEiOiJjazBteGhlOG0xODU2M2RtemE1M2x4cXM1In0.bP7TIno7NlNzMn2maHRwpQ';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: '/api/v1/users/logout' // url: 'http://127.0.0.1:8000/api/v1/users/logout',
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? // ? 'http://127.0.0.1:8000/api/v1/users/updatePassword'
            // : 'http://127.0.0.1:8000/api/v1/users/updateMe';
            '/api/v1/users/updatePassword' : '/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_NKxDE1s7myX98D4LcMiFTHCU');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId) // `http://127.0.0.1:8000/api/v1/bookings/checkout-session/${tourId}`
            );
...
var userPassworForm = document.querySelector('.form-user-password');
...
if (userPassworForm) {
  userPassworForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passwordConfirm, password, passwordCurrent;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
